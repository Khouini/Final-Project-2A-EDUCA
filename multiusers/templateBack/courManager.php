...
?>
    <?php require_once '../skanderCours/back/controller/process2.php'; ?> 
...
<body id="page-top">
    ...
    <?php endif ?>
                    <div class="container py-2 border border-dark border-3 rounded mt-3">
                        <div class="justify-content-center">
                            <form action="../skanderCours/back/controller/process2.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <input name="nameI" type="text" class="form-control" placeholder="Enter le nom du cours" value="<?php echo $name; ?>">
                                    </div>
                                </div>
                                <br>
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <input name="anneeI" name="submit" type="text" class="form-control" placeholder="Entrer l'annee scolaire" value="<?php echo $annee; ?>">
                                    </div>
                                </div>
                                <br>
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <input name="matiereI" type="text" class="form-control" placeholder="Enter la matiére" value="<?php echo $matiere; ?>">
                                    </div>
                                </div>
                                <br>
                                <!-- file -->
                            ...
                            <tbody>
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-info" href="courManager.php?edit=<?php echo $row['id']; ?>">Edit</a>
                                            <a class="btn btn-danger" href="../skanderCours/back/controller/process2.php?delete=<?php echo $row['id']; ?>">Delete</a>
                                        </td>
                                    </tr>
                                    <?php endwhile; ?>
                            </tbody>
    ...
    ?>
                        <h1 class="fs-1 font-monospace text-center  mt-4">Trouvé:</h1>
                        <div class="container border border-warning border-3 rounded">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th scope="col">#</th>
                        ...
                        while ($rowv = $resultResearch->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $rowv['matiere']; ?>
                                            </td>
                                            <td>
                                                <a class="btn btn-info" href="courManager.php?edit=<?php echo $rowv['id']; ?>">Edit</a>
                                                <a class="btn btn-danger" href="../skanderCours/back/controller/process2.php?delete=<?php echo $rowv['id']; ?>">Delete</a>
                                            </td>
                                        </tr>
                                        <?php endwhile; ?>
                                </tbody>
