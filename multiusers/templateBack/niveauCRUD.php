...
?>
<?php require_once '../yacineGame/back/controller/process.php'; ?>
                    ...
                    <?php if (isset($_SESSION['message'])): ?>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-info" href="niveauCRUD.php?edit=<?php echo $row['id']; ?>">Edit</a>
                                            <a class="btn btn-danger" href="../yacineGame/back/controller/process.php?delete=<?php echo $row['id']; ?>">Delete</a>
                                        </td>
                                    </tr>
                                    <?php endwhile; ?>
                                </tbody>
                        ...
                        <div class="container py-2 border border-primary border-2 rounded">
                            <div class="justify-content-center">
                                <form action="../yacineGame/back/controller/process.php" method="post">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <input name="niveau" type="text" id="nameInput" class="form-control" placeholder="Enter l'année scolaire" value="<?php echo $niveau; ?>">
                                        </div>
                                    </div>
                                    <br>
                                    <?php if ($update == true): ?>
