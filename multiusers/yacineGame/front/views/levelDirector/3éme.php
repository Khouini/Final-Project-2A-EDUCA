...
<body class="">
    ...
    <section id="container1" class="container">
        <h1 id="educaText" class="mt-5  display-2 text-center fw-bold">3éme année</h1>
    </section>
    <div class="container pt-5">
        <section class="row">
            <div class="col d-flex justify-content-center">
                <a href="../../../back/controller/process.php?3math" class="btn btn-outline-dark btn-lg border-3">
                    <span class="fs-1">Math</span>
                </a>
            </div>
            <div class="col d-flex justify-content-center">
                <a href="../../../back/controller/process.php?3fr" class="btn btn-outline-dark btn-lg border-3">
                    <span class="fs-1">Francais</span>
                </a>
            </div>
            <div class="col d-flex justify-content-center">
                <a href="" class="btn btn-outline-dark btn-lg border-3">
                    <span class="fs-1">Arabe</span>
                </a>
            </div>
    </div>   
