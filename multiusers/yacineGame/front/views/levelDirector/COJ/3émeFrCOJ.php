...
?>
    ...
    <section id="container1" class="container">
        <h1 id="educaText" class=" display-2 text-center fw-bold mt-5">3éme année français</h1>
    </section>
    <div class="container pt-5">
        <section class="row">
            <div class="col d-flex justify-content-center">
                <a href="../../../../back/controller/process.php?3frCours" class="btn btn-outline-dark btn-lg border-3">
                    <span class="fs-1">Cours</span>
                </a>
            </div>
            <div class="col d-flex justify-content-center">
                <a href="../../../../back/controller/process.php?3frJeux" class="btn btn-outline-dark btn-lg border-3">
