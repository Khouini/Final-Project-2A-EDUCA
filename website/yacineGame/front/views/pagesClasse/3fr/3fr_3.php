...
?>
    ...
    <section class="container">
        ...
        <div class="container1 d-flex justify-content-start">
            <p class="draggable mx-2 fs-5 fw-bolder text-light border-light" draggable="true">est</p>
            <p class="draggable mx-2 fs-5 fw-bolder text-light border-light" draggable="true">Le couffin</p>
            <p class="draggable mx-2 fs-5 fw-bolder text-light border-light" draggable="true">de fruits</p>
            <p class="draggable mx-2 fs-5 fw-bolder text-light border-light" draggable="true">plein</p>
        </div>
        <div class="container1 d-flex justify-content-start">
        </div>
        ...
        <div class="d-flex justify-content-end">
            <a hidden href="../../../controller/3frProcess/processScore3.php?score=15" id="submit2" class="buttonColor btn btn-primary mt-3 fs-4 rounded-pill  border-light border-3" type="submit">Consulter le résultat</a>
        </div>
        
    </section>
    <script src="../../../controller/assets/scriptNiveau3Fr.js"></script>
