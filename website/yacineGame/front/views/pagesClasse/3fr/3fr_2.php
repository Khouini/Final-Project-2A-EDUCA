...
?>
    ...
    <section class="container">
        ...
        <div class="container1 d-flex justify-content-start">
            <p class="draggable mx-2 fs-5 fw-bolder text-light border-light" draggable="true">La poule</p>
            <p class="draggable mx-2 fs-5 fw-bolder text-light border-light" draggable="true">plein</p>
            <p class="draggable mx-2 fs-5 fw-bolder text-light border-light" draggable="true">picore</p>
            <p class="draggable mx-2 fs-5 fw-bolder text-light border-light" draggable="true">de grains</p>
        </div>
        <div class="container1 d-flex justify-content-start">
        </div>
        ...
        <div class="d-flex justify-content-end">
            <a hidden href="../../../controller/3frProcess/processScore2.php?score=10" id="submit2" class="buttonColor btn btn-primary mt-3 fs-4 rounded-pill  border-light border-3" type="submit">Niveau Suivant</a>
        </div>
    </section>
    <script src="../../../controller/assets/scriptNiveau2Fr.js"></script>
