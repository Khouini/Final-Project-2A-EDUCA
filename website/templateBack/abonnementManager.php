...
?>
<?php require_once '../aziz/back/controller/process2.php'; ?>
<?php
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="container py-2 border border-dark border-3 rounded mt-3">
                            <div class="justify-content-center">
                                <form action="../aziz/back/controller/process2.php" method="post">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <input name="nameI" type="text" class="form-control" placeholder="Enter le nom de l'abonnement" value="<?php echo $name; ?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row align-items-center">
                ...
                while ($row = $result->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-info" href="abonnementManager.php?edit=<?php echo $row['id']; ?>">Edit</a>
                                                <a class="btn btn-danger" href="../aziz/back/controller/process2.php?delete=<?php echo $row['id']; ?>">Delete</a>
                                            </td>
                                        </tr>
                                        <?php endwhile; ?>
                                </tbody>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info" href="abonnementManager.php?edit=<?php echo $rowv['id']; ?>">Edit</a>
                                                    <a class="btn btn-danger" href="../aziz/back/controller/process2.php?delete=<?php echo $rowv['id']; ?>">Delete</a>
                                                </td>
                                            </tr>
                                            <?php endwhile; ?>
                                    </tbody>
